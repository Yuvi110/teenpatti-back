...
module.exports = {
  ...
  listBlogCategories: async function (req, res) {
    try {
      let query = {};
      let data = await Sys.App.Services.OtherAllService.getBlogCategories(
        query
      );
  ...
  blogCategoriesEdit: async function (req, res) {
    ...
    try {
      let blogCategories =
        await Sys.App.Services.OtherAllService.getBlogCategoriesDetails({
          _id: req.params.id,
        });
  ...
  getBlogCategoriesDelete: async function (req, res) {
    try {
      ...
      if (blogCategories) {
        await Sys.App.Services.OtherAllService.deleteBlogCategories(
          req.body.id
        );
